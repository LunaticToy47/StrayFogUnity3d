...
public sealed class EditorStrayFogApplication
{
    ...
    /// SQL帮助类
    /// </summary>
    public static SQLiteHelper sqlHelper { get { if (mSqlHelper == null) { mSqlHelper = new SQLiteHelper(string.Format("data source={0}", StrayFogUtility.SingleScriptableObject<StrayFogSetting>().dbSource)); } return mSqlHelper; } }
    /// <summary>
    /// 关闭数据库
    /// </summary>
