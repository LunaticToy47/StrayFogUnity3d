...
public class AnimCurve_BounceEaseIn : AbsSingle, IEditorAnimCurve
{
    ...
    public double KeyframeValue(double _time, double _curveStartingValue, double _curveFinalValue, double _curveDuration)
    {
        return _curveFinalValue - StrayFogUtility.Single<AnimCurve_BounceEaseOut>().KeyframeValue(_curveDuration - _time, 0, _curveFinalValue, _curveDuration) + _curveStartingValue;
    }
}
#endregion
...
public class AnimCurve_BounceEaseInOut : AbsSingle, IEditorAnimCurve
{
    ...
    public double KeyframeValue(double _time, double _curveStartingValue, double _curveFinalValue, double _curveDuration)
    {
        if (_time < _curveDuration / 2)
            return StrayFogUtility.Single<AnimCurve_BounceEaseIn>().KeyframeValue(_time * 2, 0, _curveFinalValue, _curveDuration) * .5 + _curveStartingValue;
        else
            return StrayFogUtility.Single<AnimCurve_BounceEaseOut>().KeyframeValue(_time * 2 - _curveDuration, 0, _curveFinalValue, _curveDuration) * .5 + _curveFinalValue * .5 + _curveStartingValue;
    }
}
#endregion
...
public class AnimCurve_SineEaseOutIn : AbsSingle, IEditorAnimCurve
{
    ...
    {
        if (_time < _curveDuration / 2)
            return StrayFogUtility.Single<AnimCurve_SineEaseOut>().KeyframeValue(_time * 2, _curveStartingValue, _curveFinalValue / 2, _curveDuration);

        return StrayFogUtility.Single<AnimCurve_SineEaseIn>().KeyframeValue((_time * 2) - _curveDuration, _curveStartingValue + _curveFinalValue / 2, _curveFinalValue / 2, _curveDuration);
    }
}
#endregion
...
public class AnimCurve_QuadEaseOutIn : AbsSingle, IEditorAnimCurve
{
    ...
    {
        if (_time < _curveDuration / 2)
            return StrayFogUtility.Single<AnimCurve_QuadEaseOut>().KeyframeValue(_time * 2, _curveStartingValue, _curveFinalValue / 2, _curveDuration);

        return StrayFogUtility.Single<AnimCurve_QuadEaseIn>().KeyframeValue((_time * 2) - _curveDuration, _curveStartingValue + _curveFinalValue / 2, _curveFinalValue / 2, _curveDuration);
    }
}
#endregion
...
public class AnimCurve_CubicEaseOutIn : AbsSingle, IEditorAnimCurve
{
    ...
    {
        if (_time < _curveDuration / 2)
            return StrayFogUtility.Single<AnimCurve_CubicEaseOut>().KeyframeValue(_time * 2, _curveStartingValue, _curveFinalValue / 2, _curveDuration);

        return StrayFogUtility.Single<AnimCurve_CubicEaseIn>().KeyframeValue((_time * 2) - _curveDuration, _curveStartingValue + _curveFinalValue / 2, _curveFinalValue / 2, _curveDuration);
    }
}
#endregion
...
public class AnimCurve_QuartEaseOutIn : AbsSingle, IEditorAnimCurve
{
    ...
    {
        if (_time < _curveDuration / 2)
            return StrayFogUtility.Single<AnimCurve_QuartEaseOut>().KeyframeValue(_time * 2, _curveStartingValue, _curveFinalValue / 2, _curveDuration);

        return StrayFogUtility.Single<AnimCurve_QuartEaseIn>().KeyframeValue((_time * 2) - _curveDuration, _curveStartingValue + _curveFinalValue / 2, _curveFinalValue / 2, _curveDuration);
    }
}
#endregion
...
public class AnimCurve_QuintEaseOutIn : AbsSingle, IEditorAnimCurve
{
    ...
    {
        if (_time < _curveDuration / 2)
            return StrayFogUtility.Single<AnimCurve_QuintEaseOut>().KeyframeValue(_time * 2, _curveStartingValue, _curveFinalValue / 2, _curveDuration);
        return StrayFogUtility.Single<AnimCurve_QuintEaseIn>().KeyframeValue((_time * 2) - _curveDuration, _curveStartingValue + _curveFinalValue / 2, _curveFinalValue / 2, _curveDuration);
    }
}
#endregion
...
public class AnimCurve_ExpoEaseOutIn : AbsSingle, IEditorAnimCurve
{
    ...
    {
        if (_time < _curveDuration / 2)
            return StrayFogUtility.Single<AnimCurve_ExpoEaseOut>().KeyframeValue(_time * 2, _curveStartingValue, _curveFinalValue / 2, _curveDuration);

        return StrayFogUtility.Single<AnimCurve_ExpoEaseIn>().KeyframeValue((_time * 2) - _curveDuration, _curveStartingValue + _curveFinalValue / 2, _curveFinalValue / 2, _curveDuration);
    }
}
#endregion
...
public class AnimCurve_CircEaseOutIn : AbsSingle, IEditorAnimCurve
{
    ...
    {
        if (_time < _curveDuration / 2)
            return StrayFogUtility.Single<AnimCurve_CircEaseOut>().KeyframeValue(_time * 2, _curveStartingValue, _curveFinalValue / 2, _curveDuration);

        return StrayFogUtility.Single<AnimCurve_CircEaseIn>().KeyframeValue((_time * 2) - _curveDuration, _curveStartingValue + _curveFinalValue / 2, _curveFinalValue / 2, _curveDuration);
    }
}
#endregion
...
public class AnimCurve_BackEaseOutIn : AbsSingle, IEditorAnimCurve
{
    ...
    {
        if (_time < _curveDuration / 2)
            return StrayFogUtility.Single<AnimCurve_BackEaseOut>().KeyframeValue(_time * 2, _curveStartingValue, _curveFinalValue / 2, _curveDuration);
        return StrayFogUtility.Single<AnimCurve_BackEaseIn>().KeyframeValue((_time * 2) - _curveDuration, _curveStartingValue + _curveFinalValue / 2, _curveFinalValue / 2, _curveDuration);
    }
}
#endregion
...
public class AnimCurve_ElasticEaseOutIn : AbsSingle, IEditorAnimCurve
{
    ...
    {
        if (_time < _curveDuration / 2)
            return StrayFogUtility.Single<AnimCurve_ElasticEaseOut>().KeyframeValue(_time * 2, _curveStartingValue, _curveFinalValue / 2, _curveDuration);
        return StrayFogUtility.Single<AnimCurve_ElasticEaseIn>().KeyframeValue((_time * 2) - _curveDuration, _curveStartingValue + _curveFinalValue / 2, _curveFinalValue / 2, _curveDuration);
    }
}
#endregion
...
public class AnimCurve_BounceEaseOutIn : AbsSingle, IEditorAnimCurve
{
    ...
    {
        if (_time < _curveDuration / 2)
            return StrayFogUtility.Single<AnimCurve_BounceEaseOut>().KeyframeValue(_time * 2, _curveStartingValue, _curveFinalValue / 2, _curveDuration);
        return StrayFogUtility.Single<AnimCurve_BounceEaseIn>().KeyframeValue((_time * 2) - _curveDuration, _curveStartingValue + _curveFinalValue / 2, _curveFinalValue / 2, _curveDuration);
    }
}
#endregion
#endif