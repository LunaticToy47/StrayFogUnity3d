...
public class AssetBundleOutput : IAssetBundleOutput
{
    ...
    /// 实例化请求事件
    /// </summary>
    public event AssetBundleOutputRequestInstantiateEventHandler OnInstantiate;
    /// <summary>
    /// 实例化指定类型对象
    /// </summary>
    ...
    public void Instantiate<T>(AssetBundleInstantiateEventHandler _callback, params object[] _extraParameter) where T : Object
    {
    ...
    /// <param name="_callback">回调</param>
    /// <param name="_extraParameter">额外参数</param>
    public void Instantiate<T>(bool _defaultSelfActive,AssetBundleInstantiateEventHandler _callback, params object[] _extraParameter) where T : Object
    {
