...
public partial class XLS_Config_Table_UserGuideConfig: AbsStrayFogSQLiteEntity
{
	...
	/// </summary>
	[SQLiteFieldType(enSQLiteDataType.Int32,enSQLiteDataTypeArrayDimension.OneDimensionArray,8,"triggerReferObjectId","","@triggerReferObjectId8",false,false)]	
	...
	///7：玩家状态
	/// </summary>
	[SQLiteFieldType(enSQLiteDataType.Int32,enSQLiteDataTypeArrayDimension.NoArray,9,"triggerConditionType","","@triggerConditionType9",false,false)]	
	...
	///7：[0:待机,1:攻击...]
	/// </summary>
	[SQLiteFieldType(enSQLiteDataType.String,enSQLiteDataTypeArrayDimension.NoArray,10,"triggerConditionValue","","@triggerConditionValue10",false,false)]	
