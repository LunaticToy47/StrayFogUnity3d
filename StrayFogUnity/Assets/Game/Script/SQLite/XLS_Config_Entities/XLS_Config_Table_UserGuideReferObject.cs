...
public partial class XLS_Config_Table_UserGuideReferObject: AbsStrayFogSQLiteEntity
{
	...
	///3：UI窗口动态生成控件
	/// </summary>
	[SQLiteFieldType(enSQLiteDataType.Int32,enSQLiteDataTypeArrayDimension.NoArray,2,"refer2DType","","@refer2DType2",false)]	
	...
	/// </summary>
	[SQLiteFieldType(enSQLiteDataType.String,enSQLiteDataTypeArrayDimension.NoArray,3,"refer2DValue","","@refer2DValue3",false)]	
	...
	///2：装备
	/// </summary>
	[SQLiteFieldType(enSQLiteDataType.Int32,enSQLiteDataTypeArrayDimension.NoArray,4,"refer2DSearchCondition","","@refer2DSearchCondition4",false)]	
	...
	///2：装备配置ID
	/// </summary>
	[SQLiteFieldType(enSQLiteDataType.String,enSQLiteDataTypeArrayDimension.NoArray,5,"refer2DSearchConditionValue","","@refer2DSearchConditionValue5",false)]	
	...
	///6：坐标
	/// </summary>
	[SQLiteFieldType(enSQLiteDataType.Int32,enSQLiteDataTypeArrayDimension.NoArray,6,"refer3DType","","@refer3DType6",false)]	
	...
	///6：坐标(x,y,z)
	/// </summary>
	[SQLiteFieldType(enSQLiteDataType.String,enSQLiteDataTypeArrayDimension.NoArray,7,"refer3DValue","","@refer3DValue7",false)]	
